...
from messages.messages import INVALID_USER_ID
...
def test_update_user(users_api_class, create_new_user, user_data_for_edit):
    user_id = create_new_user.json()['id']
    response = users_api_class.update_user(user_id, user_data_for_edit)
...
def test_update_user_with_not_exist_id(users_api_class, create_new_user, user_data_for_edit):
...
def test_update_user_with_invalid_id(users_api_class, create_new_user, user_data_for_edit, user_id):
    response = users_api_class.update_user(user_id, user_data_for_edit)
